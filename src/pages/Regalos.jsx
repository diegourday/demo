...
const gifts = [
  {
    ...
    price: "S/ 89.90",
    store: "Tienda Rumba77",
    emoji: "🧩",
    badge: true,
  },
  {
    id: 2,
    name: "Pañalera organizadora premium",
    price: "S/ 120.00",
    store: "Baby Store",
    emoji: "👜",
    reserved: false,
  ...
  {
    id: 4,
    name: "Set de biberones anti-cólicos",
    price: "S/ 75.00",
    store: "Tienda Rumba77",
    emoji: "🍼",
    badge: true,
  ...
  {
    id: 7,
    name: "Andador musical interactivo",
    price: "S/ 199.00",
    store: "Tienda Rumba77",
    emoji: "🚶",
    badge: true,
  ...
  {
    id: 12,
    name: "Set de cubiertos para bebé",
    price: "S/ 35.00",
    store: "Tienda Rumba77",
    emoji: "🥄",
    badge: true,
  ...
  {
    id: 14,
    name: "Cuna portátil con mosquitero",
    price: "S/ 350.00",
    store: "BabyPlaza",
    emoji: "🛏️",
  },
...
export default function Regalos() {
  ...
  const handleReserve = () => {
    if (!modalForm.name.trim() || !modalForm.phone.trim() || !modalForm.commit)
      return;
    setItems(
      items.map((g) =>
        g.id === selectedGift.id ? { ...g, reserved: true } : g,
      ),
    );
    ...
    <div className="page-content">
      <div className="gift-page-header">
        ...
        <p className="gift-header-text">
          ...
          {/* <br /><br /> */}
          Si deseas traer algo especial, hemos preparado una lista de regalos
          que me gustan. Elige y, si necesitas, puedo ayudarte con la compra.
        </p>
        ...
        <div className="modal-overlay" onClick={() => setSelectedGift(null)}>
          <div className="gift-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="gift-modal-card">
              ...
              <p className="gift-modal-store">
                Lo puedes encontrar en {selectedGift.store}
              </p>
              <p className="gift-modal-price">
                {selectedGift.price} (PEN) <span>referencial</span>
              </p>
            </div>
            ...
            <label className="gift-modal-checkbox">
              <input
                ...
                onChange={(e) =>
                  setModalForm({ ...modalForm, commit: e.target.checked })
                }
              />
              <span>
                Me comprometo a comprar este regalo y llevarlo al evento, o
                transferir el monto al organizador
              </span>
            </label>
