    ...
    <footer className="main-footer">
      <div className="footer-container">
        ...
        <div className="footer-header">
          <img src="/logo.svg" alt="Rumba77" loading="lazy" className="footer-logo-img" />
        ...
        <div className="footer-content">
          <div className="footer-section">
            ...
            <div className="footer-item">
              <WhatsAppIcon />
              <a href="https://wa.me/51999999999" target="_blank" rel="noopener noreferrer">Envíanos un WhatsApp</a>
            </div>
            <div className="footer-item">
              <SupportIcon />
          ...
          <div className="footer-section">
            ...
            <a href="/libro-reclamaciones" className="libro-reclamaciones-link" style={{ display: 'inline-block', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 4px 12px rgba(0,0,0,0.15)', transition: 'transform 0.2s', marginTop: '16px', alignSelf: 'flex-start' }}>
              <img src="https://www.munisanjeronimocusco.gob.pe/wp-content/uploads/2023/07/libro-de-reclamaciones.jpg.webp" alt="Libro de Reclamaciones" style={{ width: '130px', display: 'block' }} />
            </a>
          </div>
        </div>

        <div className="footer-bottom">
          <p>© {new Date().getFullYear()} Rumba77. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
